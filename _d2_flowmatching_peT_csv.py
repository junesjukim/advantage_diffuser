...
def main():
    ...
    categories = {
        ...
        "flowmatching_peT_hop": "logs/walker2d-medium-replay-v2/flowmatching_plan/peT_hopwalk_H4_T20_S{seed}_d0.99_ST20/0/rollout.json",
        "flowmatching_peT_walk": "logs/hopper-medium-replay-v2/flowmatching_plan/peT_hopwalk_H4_T20_S{seed}_d0.99_ST20/0/rollout.json",
    }
    ...
    for cat in categories.keys():
        valid_scores = [
            results[seed][cat] for seed in range(50) if results[seed][cat] is not None
        ]
        if valid_scores:
